    ...
    <ul class="navbar-nav scroll-wrap navbar-height admin_side_bar_color">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu">
          ...
          <a class="nav-item dropdown" href="<?= base_url('admincontrol/reward') ?>" aria-haspopup="dropdown" data-bs-toggle="dropdown">
            <i class="bi bi-clipboard2-data-fill"></i>
            <?= __('Khen Thưởng') ?>
            <div class="dropdown-menu">
              <a class="dropdown-item" href="<?= base_url('admincontrol/rewar_level') ?>">
                <i class="bi bi-clipboard2-data-fill"></i>
                <?= __('Cấp độ') ?></a>


              <a class="dropdown-item"  href="<?= base_url('admincontrol/reward_turnover') ?>">
                <i class="bi bi-clipboard2-data-fill"></i>
                <?= __('Doanh thu') ?></a>
            </div>
